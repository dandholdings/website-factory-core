...
def json_repair(raw_text: str, max_repair_attempts: int = 2) -> Dict[str, Any]:
    ...
    if start == -1 or end == -1 or end <= start:
        ...
        return _repair_with_llm(cleaned, "No JSON boundaries found")
    ...
    for attempt in range(max_repair_attempts):
        try:
            ...
            if attempt == max_repair_attempts - 1:
                ...
                return _repair_with_llm(json_str, f"JSON decode error: {e}")
...
def _repair_with_llm(broken_json: str, error_msg: str = "") -> Dict[str, Any]:
...
def validate_plan_schema(plan: Dict[str, Any], niche: str = "") -> Tuple[bool, List[str]]:
...
def generate_plan_contract(
    ...
    # Determine family with enhanced selection
